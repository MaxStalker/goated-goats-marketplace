...
/**
* Method to generate cadence code for NFTStorefront contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NFTStorefrontTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NFTStorefront =>`)
...
/**
* Deploys NFTStorefront transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNFTStorefront = async (props) => {
  const { addressMap = {} } = props;
  const code = await NFTStorefrontTemplate(addressMap);
